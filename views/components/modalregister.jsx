                ...
                <div className="modal-body bg-secondary">
                    ...
                    <div id="first">
                        <div className="myform form bg-secondary">
                            ...
                            <form action="/tweedr/register" method="post" name="register">
                                <div className="form-group">
                                    <label htmlFor="inputUsername">First Name</label>
                                    <input type="text"  name="name" className="form-control" id="username" placeholder="Enter User Name" required/>
                                </div>
                                <div className="form-group">
